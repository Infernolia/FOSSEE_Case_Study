...
#   
#   title_string <- paste("G Clade Strains Frequency Map at ",time)
#   p <- ggplot() +
#     geom_polygon(data = Map_plot,
#                  aes(x = long, y = lat, group = group, fill = Value),
#                  color = "black", size = 0.5) +
#     scale_fill_distiller(palette = "Reds",trans="reverse",limits = c(170,0))+
...
dir_out <- file.path("C:/Users/Aboli/Desktop/FOSSEE/Case Study/clade")
print(dir_out)
...
## save to disk
image_write(image = img_animated,path = "clade_strains_freq_animation.gif")
