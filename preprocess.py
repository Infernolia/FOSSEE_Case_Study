...
def generate_dirty(data_path: Path):
    ...
    train_filenames = []
    for filename in os.listdir(str(train_path)):
        if filename.endswith(".jpg"):
            train_filenames.append(filename)

    test_filenames = []
    for filename in os.listdir(str(test_path)):
        if filename.endswith(".jpg"):
            test_filenames.append(filename)


    for filename in train_filenames:
        shutil.copyfile(str(train_path / filename), str(input_train_path / filename))

    for filename in test_filenames:
        shutil.copyfile(str(test_path / filename), str(input_test_path / filename))
