...
class Model(object):
    ...
    def build_model(self):
        ...
        self.ImgIn  = tf.compat.v1.placeholder(tf.float32, [self.batchSize]+Img_dims, name='ImgIn')
        self.VolGT = tf.compat.v1.placeholder(tf.float32, [self.batchSize]+Vol_dims, name='VolOut')
